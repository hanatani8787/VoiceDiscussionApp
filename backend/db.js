...
db.serialize(() => {
  ...
  db.run("CREATE TABLE IF NOT EXISTS posts (id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT, content TEXT, device_id TEXT, status TEXT, created_at DATETIME DEFAULT CURRENT_TIMESTAMP)");
